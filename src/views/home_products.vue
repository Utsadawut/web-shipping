<template>
  <div
    ...
    v-if="!product_store.load_products">
    <h2>กำลังโหลดข้อมูลสินค้า...</h2>
  </div>
  <div class="row mt-2" v-else>
    <div class="col mb-2" v-for="(product, index) in search_product" :key="index">
      <div class="card" style="width: 19rem">
        ...
        <div class="card-body">
          ...
          <p class="cart-text">หมวดหมู่ {{ product.category }}</p>
          <p class="cart-text">ราคา {{ currencyTHB(product.price) }} บาท</p>
          <routerLink

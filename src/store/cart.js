...
export const useCartStore = defineStore('useCartStore', () => {
    ...
    const saveToLocalStorage = () => {
        localStorage.getItem('cart', JSON.stringify(cart.value))
    }

    const loadFromLocalStrorge = () => {
    ...
    return { cart, add_cart, loadFromLocalStrorge, cart_previews, increment_quantity, decrement_quantity, remove_cart, clear_cart, add_cart_detail,total }
})